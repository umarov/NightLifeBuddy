...
public class AdminProfile {
	 ...
	 * @param adminProfile The Entity storing the admin profile.
	 * @return a String with the email. 
	 */
	public static String getEmail(Entity adminProfile)
	{
		return (String) adminProfile.getProperty(EMAIL_PROPERTY);
	}
	 ...
	 */
	public static Entity createAdminProfile(String loginID, String name, String email) {
		...
		try {
			...
			adminProfile.setProperty(EMAIL_PROPERTY, email);
